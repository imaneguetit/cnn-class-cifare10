...
#prediction
#class_pred = model.predict(test_images, batch_size=32)
 #print(class_pred[0])
 #labels_pred = np.argmax(class_pred,axis=1)
 #print(labels_pred)
 #correct = (labels_pred == test_labels)
#print(correct)
...
#plot_images(images=images_error[0:10],
            #labels_true=labels_true[0:10],
            #nClass=nClass,
            #labels_pred=labels_error[0:10])
